...
def gallery():
    ...
    if 'username' in session:
        return render_template('gallery.html', logged_in=True, gallery=get_all_images(), x=x, y=len(get_all_images()), user=session['username'])
    return render_template('gallery.html', logged_in=False, gallery=get_all_images(), x=x, y=len(get_all_images()))
...
def user_gallery(username):
    ...
    return render_template('user_gallery.html', logged_in=False, gallery=get_image_by_owner(username), x=x, y=len(get_image_by_owner(username)))
